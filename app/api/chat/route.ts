// app/api/chat/route.ts — OpenRouter proxy với streaming SSE.
// KHÔNG expose OPENROUTER_API_KEY ra client. Mọi request từ widget đi qua đây.
...
export async function POST(req: Request) {
  ...
  // Giới hạn 20 turn cuối để tránh tốn token
